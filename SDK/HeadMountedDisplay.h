...
static_assert(sizeof(UMotionControllerComponent) == 0x0510); // 1296 bytes (0x000458 - 0x000510)
...
static_assert(offsetof(UMotionControllerComponent, Hand) == 0x045C);
static_assert(offsetof(UMotionControllerComponent, MotionSource) == 0x0460);
static_assert(offsetof(UMotionControllerComponent, CurrentTrackingStatus) == 0x046C);
static_assert(offsetof(UMotionControllerComponent, DisplayModelSource) == 0x0470);
static_assert(offsetof(UMotionControllerComponent, CustomDisplayMesh) == 0x0478);
static_assert(offsetof(UMotionControllerComponent, DisplayMeshMaterialOverrides) == 0x0480);
