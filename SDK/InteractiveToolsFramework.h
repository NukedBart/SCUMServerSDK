...
static_assert(sizeof(FBrushStampData) == 0x00B8); // 184 bytes (0x000000 - 0x0000B8)
static_assert(sizeof(UBaseBrushTool) == 0x01C8); // 456 bytes (0x0000C0 - 0x0001C8)
...
static_assert(sizeof(UGizmoBaseComponent) == 0x0478); // 1144 bytes (0x000458 - 0x000478)
static_assert(sizeof(UGizmoArrowComponent) == 0x04A0); // 1184 bytes (0x000478 - 0x0004A0)
static_assert(sizeof(UGizmoBoxComponent) == 0x04C0); // 1216 bytes (0x000478 - 0x0004C0)
static_assert(sizeof(UGizmoCircleComponent) == 0x04A0); // 1184 bytes (0x000478 - 0x0004A0)
...
static_assert(sizeof(UGizmoLineHandleComponent) == 0x04A0); // 1184 bytes (0x000478 - 0x0004A0)
static_assert(sizeof(UGizmoRectangleComponent) == 0x04B0); // 1200 bytes (0x000478 - 0x0004B0)
...
static_assert(offsetof(UBaseBrushTool, PropertyClass) == 0x0198);
static_assert(offsetof(UBaseBrushTool, BrushStampIndicator) == 0x01C0);
...
static_assert(offsetof(UGizmoBaseComponent, Color) == 0x0458);
static_assert(offsetof(UGizmoArrowComponent, Direction) == 0x0478);
static_assert(offsetof(UGizmoBoxComponent, Origin) == 0x0478);
static_assert(offsetof(UGizmoBoxComponent, Rotation) == 0x0490);
static_assert(offsetof(UGizmoBoxComponent, Dimensions) == 0x04A0);
static_assert(offsetof(UGizmoCircleComponent, Normal) == 0x0478);
static_assert(offsetof(UGizmoLineHandleComponent, Normal) == 0x0478);
static_assert(offsetof(UGizmoLineHandleComponent, Direction) == 0x048C);
static_assert(offsetof(UGizmoRectangleComponent, DirectionX) == 0x0478);
static_assert(offsetof(UGizmoRectangleComponent, DirectionY) == 0x0484);
