...
static_assert(sizeof(UDynamicMeshBrushTool) == 0x0208); // 520 bytes (0x0001C8 - 0x000208)
...
static_assert(sizeof(UMeshAttributePaintTool) == 0x0640); // 1600 bytes (0x000208 - 0x000640)
...
static_assert(sizeof(UMeshSelectionTool) == 0x04C0); // 1216 bytes (0x000208 - 0x0004C0)
...
static_assert(sizeof(USeamSculptTool) == 0x02E8); // 744 bytes (0x000208 - 0x0002E8)
...
static_assert(offsetof(UDynamicMeshBrushTool, PreviewMesh) == 0x01C8);
...
static_assert(offsetof(UMeshAttributePaintTool, AttribProps) == 0x0208);
...
static_assert(offsetof(UMeshSelectionTool, SelectionProps) == 0x0208);
static_assert(offsetof(UMeshSelectionTool, SelectionActions) == 0x0210);
static_assert(offsetof(UMeshSelectionTool, EditActions) == 0x0218);
static_assert(offsetof(UMeshSelectionTool, Selection) == 0x0220);
static_assert(offsetof(UMeshSelectionTool, SpawnedActors) == 0x0228);
...
static_assert(offsetof(USeamSculptTool, Settings) == 0x0208);
static_assert(offsetof(USeamSculptTool, PreviewGeom) == 0x0210);
