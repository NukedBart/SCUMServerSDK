...
static_assert(sizeof(UControlRigComponent) == 0x0540); // 1344 bytes (0x000458 - 0x000540)
...
static_assert(offsetof(UControlRigComponent, ControlRigClass) == 0x0458);
static_assert(offsetof(UControlRigComponent, MappedElements) == 0x04B0);
static_assert(offsetof(UControlRigComponent, ControlRig) == 0x04C8);
