...
static_assert(sizeof(UGeometryCollectionComponent) == 0x0910); // 2320 bytes (0x000480 - 0x000910)
...
static_assert(offsetof(UGeometryCollectionComponent, ChaosSolverActor) == 0x0488);
static_assert(offsetof(UGeometryCollectionComponent, RestCollection) == 0x0570);
static_assert(offsetof(UGeometryCollectionComponent, InitializationFields) == 0x0578);
static_assert(offsetof(UGeometryCollectionComponent, ObjectType) == 0x0590);
static_assert(offsetof(UGeometryCollectionComponent, DamageThreshold) == 0x05A0);
static_assert(offsetof(UGeometryCollectionComponent, ClusterConnectionType) == 0x05B0);
static_assert(offsetof(UGeometryCollectionComponent, PhysicalMaterial) == 0x05C8);
static_assert(offsetof(UGeometryCollectionComponent, InitialVelocityType) == 0x05D0);
static_assert(offsetof(UGeometryCollectionComponent, InitialLinearVelocity) == 0x05D4);
static_assert(offsetof(UGeometryCollectionComponent, InitialAngularVelocity) == 0x05E0);
static_assert(offsetof(UGeometryCollectionComponent, PhysicalMaterialOverride) == 0x05F0);
static_assert(offsetof(UGeometryCollectionComponent, CacheParameters) == 0x05F8);
static_assert(offsetof(UGeometryCollectionComponent, RepData) == 0x06B0);
static_assert(offsetof(UGeometryCollectionComponent, DummyBodySetup) == 0x08E0);
