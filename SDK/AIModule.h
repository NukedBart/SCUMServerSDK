...
static_assert(sizeof(AAIController) == 0x0330); // 816 bytes (0x000298 - 0x000330)
...
static_assert(sizeof(FAINoiseEvent) == 0x0038); // 56 bytes (0x000000 - 0x000038)
...
static_assert(sizeof(FAITeamStimulusEvent) == 0x0048); // 72 bytes (0x000000 - 0x000048)
...
static_assert(sizeof(UAISenseConfig_Hearing) == 0x0070); // 112 bytes (0x000048 - 0x000070)
...
static_assert(sizeof(UAISenseEvent_Hearing) == 0x0060); // 96 bytes (0x000028 - 0x000060)
...
static_assert(sizeof(ADetourCrowdAIController) == 0x0330); // 816 bytes (0x000330 - 0x000330)
...
static_assert(sizeof(UEQSRenderingComponent) == 0x0490); // 1168 bytes (0x000458 - 0x000490)
static_assert(sizeof(AEQSTestingPawn) == 0x0560); // 1376 bytes (0x0004C8 - 0x000560)
static_assert(sizeof(UGenericTeamAgentInterface) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(AGridPathAIController) == 0x0330); // 816 bytes (0x000330 - 0x000330)
...
static_assert(sizeof(FGenericTeamId) == 0x0010); // 16 bytes (0x000000 - 0x000010)
...
static_assert(offsetof(FAITeamStimulusEvent, Broadcaster) == 0x0038);
static_assert(offsetof(FAITeamStimulusEvent, Enemy) == 0x0040);
...
static_assert(offsetof(UAISenseConfig_Hearing, HearingOcclusionCollisionChannel) == 0x0068);
...
static_assert(offsetof(AEQSTestingPawn, QueryTemplate) == 0x04D0);
static_assert(offsetof(AEQSTestingPawn, QueryParams) == 0x04D8);
static_assert(offsetof(AEQSTestingPawn, QueryConfig) == 0x04E8);
static_assert(offsetof(AEQSTestingPawn, HighlightMode) == 0x0500);
static_assert(offsetof(AEQSTestingPawn, QueryingMode) == 0x0508);
static_assert(offsetof(AEQSTestingPawn, NavAgentProperties) == 0x0510);
