...
static_assert(sizeof(ULevelSequenceBurnIn) == 0x0328); // 808 bytes (0x000268 - 0x000328)
...
static_assert(offsetof(ULevelSequenceBurnIn, FrameInformation) == 0x0268);
static_assert(offsetof(ULevelSequenceBurnIn, LevelSequenceActor) == 0x0320);
