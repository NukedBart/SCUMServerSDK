...
/// Enum /Script/AnimGraphRuntime.EBoneRotationOrder
/// Size: 0x01 (1 bytes)
enum class EBoneRotationOrder : uint8_t
{
	EBoneRotationOrder__XYZ                                                          = 0,
	EBoneRotationOrder__XZY                                                          = 1,
	EBoneRotationOrder__YXZ                                                          = 2,
	EBoneRotationOrder__YZX                                                          = 3,
	EBoneRotationOrder__ZXY                                                          = 4,
	EBoneRotationOrder__ZYX                                                          = 5
};
...
static_assert(offsetof(FAnimNode_BoneDrivenController, RotationOrder) == 0x010F);
