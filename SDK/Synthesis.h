...
static_assert(sizeof(USynth2DSlider) == 0x0480); // 1152 bytes (0x000110 - 0x000480)
...
static_assert(sizeof(USynthKnob) == 0x0408); // 1032 bytes (0x000110 - 0x000408)
...
static_assert(offsetof(USynth2DSlider, WidgetStyle) == 0x0138);
static_assert(offsetof(USynth2DSlider, SliderHandleColor) == 0x03F0);
...
static_assert(offsetof(USynthKnob, ParameterName) == 0x0128);
static_assert(offsetof(USynthKnob, ParameterUnits) == 0x0140);
static_assert(offsetof(USynthKnob, WidgetStyle) == 0x0168);
