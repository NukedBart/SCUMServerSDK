...
static_assert(sizeof(ARecastNavMesh) == 0x0578); // 1400 bytes (0x000428 - 0x000578)
...
static_assert(sizeof(UNavigationInvokerComponent) == 0x00C0); // 192 bytes (0x0000B0 - 0x0000C0)
...
static_assert(sizeof(UNavigationSystemV1) == 0x15D0); // 5584 bytes (0x000028 - 0x0015D0)
...
static_assert(sizeof(UNavLinkComponent) == 0x0470); // 1136 bytes (0x000458 - 0x000470)
...
static_assert(sizeof(UNavLinkRenderingComponent) == 0x0460); // 1120 bytes (0x000458 - 0x000460)
...
static_assert(sizeof(UNavMeshRenderingComponent) == 0x0470); // 1136 bytes (0x000458 - 0x000470)
...
static_assert(sizeof(UNavTestRenderingComponent) == 0x0460); // 1120 bytes (0x000458 - 0x000460)
...
static_assert(offsetof(UNavigationInvokerComponent, NavigationDataToUpdate) == 0x00B8);
...
static_assert(offsetof(UNavigationSystemV1, OperationMode) == 0x01AC);
...
static_assert(offsetof(UNavLinkComponent, Links) == 0x0460);
