...
static_assert(sizeof(ALandscapeProxy) == 0x05F0); // 1520 bytes (0x000220 - 0x0005F0)
static_assert(sizeof(ALandscape) == 0x05F0); // 1520 bytes (0x0005F0 - 0x0005F0)
...
static_assert(sizeof(ULandscapeComponent) == 0x0680); // 1664 bytes (0x000458 - 0x000680)
...
static_assert(sizeof(ULandscapeGizmoRenderComponent) == 0x0460); // 1120 bytes (0x000458 - 0x000460)
...
static_assert(sizeof(ULandscapeHeightfieldCollisionComponent) == 0x0548); // 1352 bytes (0x000458 - 0x000548)
...
static_assert(sizeof(ULandscapeSplinesComponent) == 0x0490); // 1168 bytes (0x000458 - 0x000490)
...
static_assert(sizeof(ALandscapeStreamingProxy) == 0x0610); // 1552 bytes (0x0005F0 - 0x000610)
...
static_assert(offsetof(ULandscapeComponent, OverrideMaterial) == 0x0470);
static_assert(offsetof(ULandscapeComponent, OverrideHoleMaterial) == 0x0478);
static_assert(offsetof(ULandscapeComponent, OverrideMaterials) == 0x0480);
static_assert(offsetof(ULandscapeComponent, MaterialInstances) == 0x0490);
static_assert(offsetof(ULandscapeComponent, MaterialInstancesDynamic) == 0x04A0);
static_assert(offsetof(ULandscapeComponent, LODIndexToMaterialIndex) == 0x04B0);
static_assert(offsetof(ULandscapeComponent, MaterialIndexToDisabledTessellationMaterial) == 0x04C0);
static_assert(offsetof(ULandscapeComponent, XYOffsetmapTexture) == 0x04D0);
static_assert(offsetof(ULandscapeComponent, WeightmapScaleBias) == 0x04E0);
static_assert(offsetof(ULandscapeComponent, HeightmapScaleBias) == 0x0500);
static_assert(offsetof(ULandscapeComponent, CachedLocalBox) == 0x0510);
static_assert(offsetof(ULandscapeComponent, CollisionComponent) == 0x052C);
static_assert(offsetof(ULandscapeComponent, HeightmapTexture) == 0x0548);
static_assert(offsetof(ULandscapeComponent, WeightmapLayerAllocations) == 0x0550);
static_assert(offsetof(ULandscapeComponent, WeightmapTextures) == 0x0560);
static_assert(offsetof(ULandscapeComponent, LODStreamingProxy) == 0x0570);
static_assert(offsetof(ULandscapeComponent, MapBuildDataId) == 0x0578);
static_assert(offsetof(ULandscapeComponent, IrrelevantLights) == 0x0588);
static_assert(offsetof(ULandscapeComponent, StateId) == 0x05B4);
static_assert(offsetof(ULandscapeComponent, BakedTextureMaterialGuid) == 0x05C4);
static_assert(offsetof(ULandscapeComponent, GIBakedBaseColorTexture) == 0x05D8);
static_assert(offsetof(ULandscapeComponent, MobileMaterialInterface) == 0x05E8);
static_assert(offsetof(ULandscapeComponent, MobileMaterialInterfaces) == 0x05F0);
static_assert(offsetof(ULandscapeComponent, MobileWeightmapTextures) == 0x0600);
...
static_assert(offsetof(ULandscapeHeightfieldCollisionComponent, ComponentLayerInfos) == 0x0458);
static_assert(offsetof(ULandscapeHeightfieldCollisionComponent, CollisionQuadFlags) == 0x0480);
static_assert(offsetof(ULandscapeHeightfieldCollisionComponent, HeightfieldGuid) == 0x0490);
static_assert(offsetof(ULandscapeHeightfieldCollisionComponent, CachedLocalBox) == 0x04A0);
static_assert(offsetof(ULandscapeHeightfieldCollisionComponent, RenderComponent) == 0x04BC);
static_assert(offsetof(ULandscapeHeightfieldCollisionComponent, CookedPhysicalMaterials) == 0x04E8);
...
static_assert(offsetof(ULandscapeSplinesComponent, ControlPoints) == 0x0458);
static_assert(offsetof(ULandscapeSplinesComponent, Segments) == 0x0468);
static_assert(offsetof(ULandscapeSplinesComponent, CookedForeignMeshComponents) == 0x0478);
...
static_assert(offsetof(ALandscapeStreamingProxy, LandscapeActor) == 0x05F0);
